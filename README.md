...
| -------------- | ----------------- | ------ |
| 2.x            | `0.2.x` or `2.x` | [`main`](https://github.com/FFans/creator-declarations/tree/main) |
| 1.x            | `0.1.x` or `1.x` | [`1.x`](https://github.com/FFans/creator-declarations/tree/1.x) |
